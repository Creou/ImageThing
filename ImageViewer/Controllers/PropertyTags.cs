...
namespace ImageViewer.Controllers
{
	...
	{
		public static Dictionary<int, string> Definitions = new Dictionary<int, string>
		{
			{ 0x0000, "GpsVer"},
		...
		public static Dictionary<string, int> Ids = Definitions.ToDictionary(k => k.Value, v => v.Key);
	}
}
